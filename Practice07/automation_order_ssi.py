...
driver = webdriver.Chrome("F:\OneDrive - itbclub\Hoc Ky\NCKH\Paper\01. Sentiment Analysis\Github\Sentiment-based-recommendation\00. Crawling Data\chromedriver.exe")
